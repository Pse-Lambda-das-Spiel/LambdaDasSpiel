...
\item[Attribute] \hfill \\
	\vspace{-.8cm}
	\begin{itemize}
		\item $\texttt{private String \textbf{ID}}$ \\ Gibt den eindeutigen Bezeichner des Items an.
...
\item[Attribute] \hfill \\
	\vspace{-.8cm}
	\begin{itemize}
		\item $\texttt{private int \textbf{ID}}$ \\ Ist der eindeutige Identifizierer eines Levels.
...
\subsubsection{\normalfont \texttt{public class \textbf{ShopViewControllerl} extends Controller}}
...
\subsubsection{\normalfont \texttt{public class \textbf{ShopItemViewControllerl} extends Controller}}
