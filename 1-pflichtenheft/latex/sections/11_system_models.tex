...
\begin{figure}[H]
\centering
\includegraphics[scale=0.6]{../system_models/dynamic_models/menu_state_machine.pdf}
...
% ------------ Editor-Modus mit aktiviertem Lehrermodus ---------------
...
\end{figure}
\begin{description*}
\item[PS1] Schritt-Rückwärts-Button: Führt einen Reduktionsschritt aus
\item[PS2] Abspiel-Button: Startet das automatische Reduzieren
\item[PS3] Schritt-Vorwärts-Button: Macht den letzten Reduktionsschritt rückgängig
\item[PS4] Zurück-Button: Wechselt zurück in den Editor-Modus $($Abb. \ref{fig:Editor-Modus}$)$
\end{description*}
...
% ---------- Einkaufsmenü mit geöffnetem Musik-Dropdownmenü ----------
