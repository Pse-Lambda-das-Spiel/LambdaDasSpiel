 ...
 */
public class AchievementViewController extends ImageButton implements
        AchievementModelObserver {

    private AchievementModel achievement;

    /**
     * Creates a new AchievementViewController with the given
     * {@link AchievementModel}.
     * 
     * @param achievement
     *            the to be displayed {@link AchievementModel}
     */
    ...
    public void changedLockedState() {
        if (achievement.isLocked()) {
            setStyle(AchievementMenuViewController
                    .getImageButtonStyle(achievement
                            .getIconPathAchievementLocked()));
        } else {
            setStyle(AchievementMenuViewController
                    .getImageButtonStyle(achievement
                            .getIconPathAchievementUnlocked()));
        }
    }
    ...
    public void initializeButton() {
        setStyle(AchievementMenuViewController.getImageButtonStyle(achievement
                .getIconPathAchievementLocked()));
    }
