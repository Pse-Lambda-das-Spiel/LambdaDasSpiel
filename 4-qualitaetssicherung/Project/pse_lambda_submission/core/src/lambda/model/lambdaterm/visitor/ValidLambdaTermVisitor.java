...
/**
 * Represents a visitor on a lambda term tree that checks if the visited tree is
 * a valid term before visiting it.
 * 
...
public abstract class ValidLambdaTermVisitor<T> implements LambdaTermVisitor<T> {
    /**
     * The message of the exception that will be thrown if the visited term
     * isn't valid.
     */
     ...
     *            the message of the exception that will be thrown if the
     *            visited term isn't valid
     */
    ...
    /**
     * Visits the given lambda root, checks the term for validity and then calls
     * visitValid.
     * 
     * @param node
    ...
    /**
     * Visits the given lambda application, checks the term for validity and
     * then calls visitValid.
     * 
     * @param node
    ...
    /**
     * Visits the given lambda abstraction, checks the term for validity and
     * then calls visitValid.
     * 
     * @param node
    ...
    /**
     * Visits the given lambda variable, checks the term for validity and then
     * calls visitValid.
     * 
     * @param node
    ...
    /**
     * Checks the given term for validity and throws an exception if the term is
     * invalid.
     * 
     * @param term
