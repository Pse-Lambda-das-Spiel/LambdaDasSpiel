...
/**
 * This class serves as the statistic of a profile for the data gained through
 * playing the levels of the game.
 * 
...
public class StatisticModel extends Observable<StatisticModelObserver> {
     ...
     * 
     * @param hintsNotUsed
     *            the number of successful level tries without using the hint to
     *            set
     */
    ...
    /**
     * 
     * Returns the string representation of the played time in the format
     * "h min s".
     * 
    ...
    public String convertTimeToString() {
        ...
        long min = sec / 60;
        sec %= 60;
        String result = hours + " h  " + String.format("%02d", min) + " min  "
