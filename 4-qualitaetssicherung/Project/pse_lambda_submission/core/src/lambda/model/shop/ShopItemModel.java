...
public class ShopItemModel extends Observable<ShopItemModelObserver> {
    ...
    /**
     * Deactivates this item if its activated and sets the activated item on the
     * category to "null"
     */
    @SuppressWarnings("unchecked")
    ...
    /**
     * Returns if the item is already purchased. true, if the item is purchased
     *
    ...
    /**
     * Sets the new state of this item and notifies the other classes about this
     * change
     * 
     * @param activated
     *            is the boolean to set
     */
