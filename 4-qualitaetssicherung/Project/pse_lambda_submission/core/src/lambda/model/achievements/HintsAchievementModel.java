...
/**
 * This class represents an achievement unlocked by solving a specific number of
 * levels without using the hint.
 * 
...
public class HintsAchievementModel extends AchievementModel {
     ...
     * 
     * @param reqHintsNotUsed
     *            the number of solved level without used hint needed for
    ...
    public void reset(AssetManager assets) {
        ...
        setRequirementsDescription(bundle.format("reqHintsAchievement",
                reqHintsNotUsed));
    }
