...
public class LambsEnchantedAchievementModel extends AchievementModel {
     ...
     * 
     * @param reqLambsEnchanted
     *            the number of enchanted lambs needed for unlocking the
     *            achievement
     */
    ...
    public void reset(AssetManager assets) {
        ...
        setDescription(bundle.format("lambsEnchantedAchievement",
                reqLambsEnchanted));
        setRequirementsDescription(bundle.format(
                "reqLambsEnchantedAchievement", reqLambsEnchanted));
    }
