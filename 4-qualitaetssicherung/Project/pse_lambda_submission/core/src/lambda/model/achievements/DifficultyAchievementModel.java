...
/**
 * This class represents an achievement unlocked by solving all levels of a
 * specific difficulty.
 * 
...
public class DifficultyAchievementModel extends AchievementModel {
     ...
     * 
     * @param difficultyId
     *            the identifier of the specific difficulty
     */
    public DifficultyAchievementModel(int difficultyId) {
        this.reqLevelPerDifficultySolved = difficultyId
    ...
    public void reset(AssetManager assets) {
        ...
        setDescription(bundle
                .format("difficultyAchievement", reqLevelPerDifficultySolved
                        / LevelManager.LEVEL_PER_DIFFICULTY));
        setRequirementsDescription(bundle
                .format("reqDifficultyAchievement", reqLevelPerDifficultySolved
                        / LevelManager.LEVEL_PER_DIFFICULTY));
    }
