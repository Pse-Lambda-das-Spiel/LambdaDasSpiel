 ...
 * Implement this interface to keep a class informed on changes during the editing of profiles.
 * 
 * @author Kai Fieger
 */
public interface ProfileEditObserver {
    ...
    /**
	 * Gets called by an observed ProfileEditModel-object as the selected language is changed.
    ...
    /**
	 * Gets called by an observed ProfileEditModel-object as the selected avatar is changed.
     * The default implementation is empty.
	 */
