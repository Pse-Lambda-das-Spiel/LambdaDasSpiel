...
/**
 * Represents a visitor on a lambda term that performs a beta reduction with call-by-value strategy. Can only visit a valid lambda term.
 * 
 * Strategy:
 * 1. Applications: Right child reduced before left child
 * 2. Abstractions: Apply only arguments that are values, don't reduce inner term
 * 
...
public class ReductionStrategyCallByValue extends BetaReductionVisitor {
    ...
    /**
     * Visits the given lambda application and performs a call-by-value reduction if possible.
     * 
    ...
    /**
     * Visits the given lambda abstraction and performs a call-by-value reduction if possible.
     * 
