...
/**
 * Represents a visitor on a lambda term that copies the visited lambda term.
 * Can copy invalid lambda terms.
 *
...
public class CopyVisitor implements LambdaTermVisitor<LambdaTerm> {
    ...
    /**
     * Visits the given lambda application. Saves a new application as result
    ...
    /**
     * Visits the given lambda abstraction. Saves a new abstraction as result
