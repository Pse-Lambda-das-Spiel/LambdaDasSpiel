 ...
 */
public abstract class AchievementModel extends
        Observable<AchievementModelObserver> implements StatisticModelObserver,
    ...
    /**
     * Checks with the given StatisticModel whether the requirements of this
     * achievement are met or not. Sets the locked-/unlocked-state of this
     * achievement accordingly.
     * 
     * @param statistic
     *            the StatisticModel with whitch the check of the requirements
     *            is done
     * @throws IllegalArgumentException
     ...
     * 
     * @param requirementsDescription
     *            the requirementsDescription to set
     */
     ...
     * 
     * @param iconPathAchievementUnlocked
     *            the iconPathAchievementUnlocked to set
     */
    public void setIconPathAchievementUnlocked(
     ...
     * 
     * @param iconPathAchievementLocked
     *            the iconPathAchievementLocked to set
     */
