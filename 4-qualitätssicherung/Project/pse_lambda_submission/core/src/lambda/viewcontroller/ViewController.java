...
/**
 * This class is a superclass for all ViewController that represent a screen.
 * The order in which the view controllers are initialized is: 1. constructor:
 * create class instance and model 2. queueAssets: queue assets for loading 3.
 * create: create ui elements using loaded assets
 * 
...
public abstract class ViewController implements Screen, ProfileManagerObserver {
     ...
     * 
     * @param game
     *            the reference to the main class to set
     */
    ...
    /**
     * Called when the view conroller is created after the assets are loaded.
     * Create ui elements.
     * 
     * @param manager
     *            the asset manager with loaded assets
     */
