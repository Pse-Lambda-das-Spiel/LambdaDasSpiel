...
/**
 * Represents an object in the observer pattern that can be observed by multiple
 * observers.
 * 
 * @param <Observer>
...
public class Observable<Observer> {
    ...
    /**
     * Adds an observer to this observable if it isn't already observing this
     * object.
     * 
     * @param observer
     *            the new observer
    ...
    /**
     * Removes the given observer from this observable if it is currently
    ...
    /**
     * Notifies all observers of a change by calling the given consumer on all
     * observers.
     * 
     * @param message
