 ...
 * Implement this interface to keep a class informed on the changed
 * locked-/unlocked-state of an AchievementModel.
 * 
...
public interface AchievementModelObserver {
    ...
    /**
     * Gets called by an observed AchievementModel-object if its
     * locked-/unlocked-state has changed. The default implementation is empty.
     */
