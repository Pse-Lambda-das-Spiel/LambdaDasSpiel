 ...
 */
public class GemsEnchantedPerLevelAchievementModel extends
     ...
     * 
     * @param reqGemsEnchantedPerLevel
     *            the number of enchanted gems in a level needed for unlocking
     *            the achievement
     */
    ...
    public void reset(AssetManager assets) {
        ...
        setDescription(bundle.format("gemsEnchantedPerLevelAchievement",
                reqGemsEnchantedPerLevel));
        setRequirementsDescription(bundle
                .format("reqGemsEnchantedPerLevelAchievement",
                        reqGemsEnchantedPerLevel));
    }
