 ...
 */
public class GemsPlacedPerLevelAchievementModel extends
     ...
     * 
     * @param reqGemsPlacedPerLevel
     *            the number of placed gems in a level needed for unlocking the
     *            achievement
     */
    ...
    public void reset(AssetManager assets) {
        ...
        setDescription(bundle.format("gemsPlacedPerLevelAchievement",
                reqGemsPlacedPerLevel));
        setRequirementsDescription(bundle.format(
                "reqGemsPlacedPerLevelAchievement", reqGemsPlacedPerLevel));
    }
